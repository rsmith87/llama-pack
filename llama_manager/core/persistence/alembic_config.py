...
from llama_manager.core.persistence.db_infra import PersistenceUrls, resolve_persistence_urls
...
DB_TARGETS: tuple[str, ...] = ("controller", "auth", "audit", "chat_sessions", "downloads", "benchmarks")
