...
from llama_pack.api.dependencies import get_chat_scheduler, get_config, get_node_registry, get_process_manager, get_profile_activation_service, get_project_graph_store, get_project_store, get_thread_service
from llama_pack.api.routes.openai_chat_completion import (
    OpenAIChatCompletionService,
    OpenAIChatCompletionsRequest,
    apply_document_collection_context,
    track_stream_for_local_model,
)
...
from llama_pack.api.routes.compat_chat import CompatChatHTTPError, controller_chat, controller_stream
from llama_pack.core.agent_tools.registry import ToolRegistry
from llama_pack.core.code_graph.tools import project_graph_tool_definitions
    ...
    try:
        if body.stream:
            ...
            if config.mode != "controller":
                stream = track_stream_for_local_model(manager, body.model, stream)
...
async def openai_chat_completions(
    ...
    return await OpenAIChatCompletionService(
        config=config,
        scheduler=scheduler,
        manager=manager,
        ...
        project_graph_store=project_graph_store,
