...
class ProjectGraphStoreOrm:
    ...
    def replace_snapshot_graph(
        ...
        with session_scope(self.session_factory) as session:
            ...
            session.execute(delete(ProjectGraphRelationOrm).where(ProjectGraphRelationOrm.snapshot_id == snapshot_id))
            session.execute(delete(ProjectGraphImportOrm).where(ProjectGraphImportOrm.snapshot_id == snapshot_id))
            session.execute(delete(ProjectGraphSymbolOrm).where(ProjectGraphSymbolOrm.snapshot_id == snapshot_id))
            session.execute(delete(ProjectGraphFileOrm).where(ProjectGraphFileOrm.snapshot_id == snapshot_id))
