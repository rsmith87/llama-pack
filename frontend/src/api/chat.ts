...
import type { ChatRequest, ChatResponse, ChatSessionsResponse, ContextBudget } from "../types/index";
...
export function getContextBudget(modelName: string, payload: Record<string, unknown>, signal: AbortSignal) { return apiPost<ContextBudget>(`/chat/${encodeURIComponent(modelName)}/context-budget`, payload, { signal }); }
